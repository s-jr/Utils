...
public class CustomDAOReader<T extends DBObject<P>, P extends Number, R> extends AbstractPagingItemReader<R> {
	...
	/**
	 * Erstellt einen neuen {@link CustomDAOReader} an mit einer {@link PaginationDAO}
	 ...
	 */
	public CustomDAOReader(PaginationDAO<T, P> dao, KlauselFunction join, KlauselFunction where, BiFunction<Integer, Integer, ParameterList> params, KlauselFunction limit, KlauselFunction order, final Function<List<T>, List<R>> mapper) {
	 ...
	 */
	public CustomDAOReader(PaginationDAO<T, P> dao, KlauselFunction join, KlauselFunction where, BiFunction<Integer, Integer, ParameterList> params, KlauselFunction limit, KlauselFunction order, final Function<List<T>, List<R>> mapper, DBObjectFunction loadedObjects) {
		this.dao = dao;
		this.join = join;
		this.where = where;
		this.params = params;
